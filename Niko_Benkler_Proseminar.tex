...
\subsection{A comparison between traditional deployment and the CD process}

\begin{tabular}{p{2cm}|p{5cm}|p{5cm}|}
\hline
  & Traditional deployment & Continuous Practices \\
 \hline
 Frequency of deployment & Every 1-6 month & Daily
\end{tabular}
