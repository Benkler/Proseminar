...
- some domains do not allow to truly implement CD, embedded systems, telecommunication/medical systems safety critical systems
...
\cite{shahin2017continuous}  
- lack of proper test stratey, poor test quality, =>cross-team testing,, test-driven-development
- merging confilcts => branching strategies, Trunk 
