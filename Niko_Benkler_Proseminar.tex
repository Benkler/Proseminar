...
The Version Control System manages the continuous code pushing to the repository. It tracks files to create a history about the development process. The most popular ones are GitHub and Subversion. GitHub Issues as Issue Tracking software can be integrated here as well. \cite{taheritanjani2016comparison}.
\subsubsection{Code Management and Analysis}
Code Management and Analysis tools check the code concerning static quality metrics. Those can be: code and test coverage, coding standards like comments or alignment or duplicated code. SonarQube is on of the most popular tools, as it can be fully integrated in CI environment \cite{shahin2017continuous}.
