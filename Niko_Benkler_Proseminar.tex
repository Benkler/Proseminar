...
Automation of configuration and provisioning of servers, test environments, virtual machines or the entire infrastructure is an innovation in deployment pipelines \cite{shahin2017continuous}. Usually, a vast amount of time is needed to set up those environments \cite{chen2015towards}. This justifies that new approach, albeit there a currently not that many tools available. 
